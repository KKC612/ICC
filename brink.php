...
<body id="brink" class="sales singular">
...
<?php include("menu.php"); ?>
	...
	<div class="entry-content">
		<h1 class="entry-title" style="font-family: 'Raleway';">On the Brink<br />
<span class="cursive">For Couples on Their Last Chance, or Deciding to Stay or Leave</span></h1>

<p style="text-align:center;margin-top: 10px;"><iframe width="560" height="315" src="https://www.youtube.com/embed/hgcdvTIszvg" frameborder="0" allowfullscreen></iframe></p>
...
<h2>Whether you decide to work on your relationship or have a healthy parting – the vast majority of couples who participate in the On the Brink program <span class="cursive">have a clear direction by the end of the 3 days.</span></h2>

<div class="highlight-box"><div class="testimonial"><p style="text-align: center;">Contact us now and let us help.<br> <span class="cursive">Your life can be better.</span><br> Let us help you get your life moving again. </p>
